              ...
              <div className="flex flex-col xl:flex-row justify-center mb-4">
                <div className="flex justify-center">
                  <a
                    ...
                    className="group cursor-pointer transition ease-in-out duration-300 hover:-translate-y-1 hover:scale-110 jersey text-2xl inline-flex text-gray-400 bg-stronghold-jet border-0 py-2 px-6 focus:outline-none focus:bg-stronghold-imperial-red hover:bg-stronghold-imperial-red hover:text-stronghold-platinum rounded">
