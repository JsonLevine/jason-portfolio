    ...
    <>
     {/* Place on side for medium+ */}
      ...
      <div className="hidden md:flex lg:ml-4 fixed flex-col items-center justify-center w-12 right-0 top-0">
          ...
          <a href="mailto:jason.levine131@gmail.com" className="transition ease-in-out duration-300 hover:text-stronghold-red hover:translate-y-1 mt-[6rem] rotate-90">jason.levine131@gmail.com</a>
      </div>
