        ...
        <div className="flex flex-wrap my-4">
          {testimonials.map((testimonial) => (
            <div key={testimonial.name}className="cursor-default p-2 lg:w-1/2 w-full group">
              <div className="h-full bg-stronghold-jet bg-opacity-80 p-4 md:p-8 rounded transition ease-in-out duration-300 group-hover:ring-4 group-hover:ring-stronghold-green/50">
                ...
                <div className="inline-flex items-center">
                  ...
                  <span className="flex-grow flex flex-col pl-4">
                    ...
                    <span className="jersey text-chewy-blue-accessible text-xl uppercase">
                      {testimonial.company}
                    </span>
