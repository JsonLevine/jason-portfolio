        ...
        <section id="projects" className="text-gray-400 body-font" data-testid="projects-section">
          <div className="container px-10 py-10 mx-auto text-center lg:px-40">
            <div className="flex flex-col w-full mb-10">
              <div ref={titleRef} className={ isTitleInView ? "animate-fade animate-once animate-duration-[1500ms] animate-ease-in-out" : ""} data-testid="section-title">
              ...
              <p ref={contentRef} className={ isContentInView ? "animate-fade animate-once animate-duration-[1500ms] animate-ease-in-out xl:w-2/3 pb-4 mx-auto leading-relaxed text-base" : "opacity-0 xl:w-2/3 pb-4 mx-auto leading-relaxed text-base"} data-testid="section-description">
              ...
              <p className={ isContentInView ? "animate-fade animate-once animate-duration-[1500ms] animate-ease-in-out xl:w-2/3 mx-auto leading-relaxed text-base pt-4 border-t border-custom-red" : "opacity-0 xl:w-2/3 mx-auto leading-relaxed text-base pt-4 border-t border-custom-red"} data-testid="section-description-2">
            ...
            <div ref={projectRef} className={ isProjectInView ? "animate-fade-down animate-once animate-duration-[1500ms] animate-ease-in-out flex flex-wrap -m-4" : "flex flex-wrap -m-4"} data-testid="projects-list">
