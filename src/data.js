...
export const testimonials = [
  {
    ...
    image: "./assets/Chris_headshot.jpg",
  ...
  },
  {
    ...
    image: "./assets/Aditya_headshot.jpg",
    name: "Aditya Jain",
    company: "Chewy",
...
export const skills = [
  ...
  {name: "Microsoft Office", icon: "./assets/icons/Office-logo.svg"},
  {name: "JIRA", icon: "./assets/icons/Jira-logo.svg"},
  {name: "Confluence", icon: "./assets/icons/Confluence-logo.svg"},
